...
namespace NINA.Plugins.PolarAlignment.OAPA {
    public partial class UniversalPolarAlignmentOAPAVM : UniversalPolarAlignmentBaseVM {
        ...
        protected override IPolarAlignmentSystem CreateSystemTcp(string host, int port) =>
            new UniversalPolarAlignmentOAPA(host, port);

        protected override IPolarAlignmentSystem CreateSystemAutoTcp(int port) =>
            new UniversalPolarAlignmentOAPA(port);

        // --- Connection mode ---

        public override ConnectionMode ConnectionMode {
            get => Properties.Settings.Default.OAPAConnectionMode;
            set {
                Properties.Settings.Default.OAPAConnectionMode = value;
        ...
        public override string TcpHost {
            get => Properties.Settings.Default.OAPATcpHost;
            set {
                Properties.Settings.Default.OAPATcpHost = value;
                CoreUtil.SaveSettings(Properties.Settings.Default);
                RaisePropertyChanged();
            }
        }
        ...
        public override int TcpPort {
            get => Properties.Settings.Default.OAPATcpPort;
            set {
                Properties.Settings.Default.OAPATcpPort = value;
                CoreUtil.SaveSettings(Properties.Settings.Default);
                RaisePropertyChanged();
            }
        }
